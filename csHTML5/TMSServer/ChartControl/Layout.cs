    ...
    public class Layout
    {
        ...
        public string Title
        {
            ...
            set
            {
                ...
                Interop.ExecuteJavaScript("$0['title'] = $1;", jsLayout, this.Title);
            }
        }
        ...
        public int Width
        {
            ...
            set
            {
                _Width = value;
                var jsLayout = Interop.ExecuteJavaScript(@"new Object()");
                Interop.ExecuteJavaScript("$0['width'] = $1", jsLayout, _Width);
            }
        }
        ...
        public int Height
        {
            ...
            set
            {
                _Height = value;
                var jsLayout = Interop.ExecuteJavaScript(@"new Object()");
                Interop.ExecuteJavaScript("$0['height'] = $1", jsLayout, _Height);
            }
        }
