...
namespace TMSServer
{
    ...
    //xaml
    //<local:ucButton  IsShadow="True" ImgSrc = "ms-appx:/Img/1.png" TextHorizentalAllignment="Center"  TextVerticalAllignment="Center" TextMargin="30,0,0,0" TextSize="30" Text="안녕" IsTextBold="True"   x:Name="m_ucButton"/>
    ...
    public partial class ucButton : UserControl
    {
            ...
            set
            {
                try
                {
                    ...
                    if (_TextHorizentalAllignment == "Left")
                        ...
                        m_tbxText.HorizontalAlignment = HorizontalAlignment.Center;
        ...
        public ucButton()
        {
            ...
            //this.m_btn.PointerEntered  += m_btn_PointerEntered;
            //this.m_btn.PointerExited   += m_btn_PointerExited;
            this.m_btn.PointerPressed  += m_btn_PointerPressed;
            this.m_btn.PointerReleased += m_btn_PointerReleased;
        }
        ...
        void m_btn_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            Leave();
        }
        ...
        void m_btn_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            Entered();
        }
        ...
        void ButtonUp()
        {
            try
            {
                ...
                var timerFlag = new DispatcherTimer { Interval = TimeSpan.FromMilliseconds(50) };
                timerFlag.Tick += (senderTimer, args) =>
                {
                    timerFlag.Stop();
                    bClicked = false;
                };
                ...
                ButtonArgs argsBtn = new ButtonArgs(Text);
                if (EvtClicked != null)
                {
        ...
        void m_btn_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            ButtonUp();
        }
        ...
        void ButtonDown()
        {
            try
            {
                Grid gdContent = this.m_btn.Content as Grid;
                if (gdContent != null)
                {
                    this.RenderTransformOrigin =  new Point(0.5, 0.5);
                    TranslateTransform transform = new TranslateTransform();
        ...
        void m_btn_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            ButtonDown();
        }
    }
